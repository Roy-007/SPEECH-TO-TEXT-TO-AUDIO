...
timeText = tk.Label(root, text="00:00:00", font=("Helvetica", 100))
timeText.pack()

startButton = tk.Button(root, text='Start',width=5,height=2,font=('Helvetica','20'), command=start)
startButton.pack()

pauseButton = tk.Button(root, text='Pause',width=5,height=2,font=('Helvetica','20'), command=pause)
pauseButton.pack()

resetButton = tk.Button(root, text='Reset',width=5,height=2,font=('Helvetica','20'), command=reset)
resetButton.pack()

quitButton = tk.Button(root, text='Quit',width=5,height=2,font=('Helvetica','20'), command=exist)
quitButton.pack()
